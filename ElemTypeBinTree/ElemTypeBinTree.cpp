...
int main() {//二叉树创建、遍历、重构和输出测试用例
	...
	int index = 0;
	//先序遍历创建二叉树
	int str[] = { 1,2,4,12,3,NULL,7 };
	tree = BinTree<int>::create(str, index);
	tree->output();
	...
	////已知先序和中序，重构二叉树
	//tree = BinTree<int>::rebuildByPreIn("abdgcefh", "dgbaechf", 8);
	//tree->output();

	////已知后序和中序，重构二叉树
	//tree = BinTree<int>::rebuildByPostIn("IJDKEBGHFCA", "IDJBKEACGFH", 11);
	//tree->output();
